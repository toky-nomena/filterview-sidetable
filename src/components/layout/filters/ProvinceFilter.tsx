...
import { Province } from "@/types/schema";
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from "@/components/ui/collapsible";
import { ChevronDown } from "lucide-react";

const provinces: Province[] = ["AB", "BC", "MB", "NB", "NL", "NS", "ON", "PE", "QC", "SK"];
...
export const ProvinceFilter = ({ selectedProvinces, onChange }: ProvinceFilterProps) => {
  return (
